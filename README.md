# Front & Back End hotel reservation website

## Frameworks & Languages: ## 
React, Express/Node, MongoDB, TailwindCSS
## Project Pages: ## 
...
+ The React **`<Calendar />` component** shows the dates disabled for the dates when the room had already been reserved. 
